...
pub use super::{
    ...
    challenges_cloze_attempts::Entity as ChallengesClozeAttempts,
    challenges_cloze_blanks::Entity as ChallengesClozeBlanks,
    challenges_cloze_options::Entity as ChallengesClozeOptions,
    challenges_clozes::Entity as ChallengesClozes,
